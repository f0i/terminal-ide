...
public class tutadaptor extends gen_adaptor{
    ...
    public tutadaptor(Context zContext){
        ...
        items.add(new tutlistitem(zContext, "Midnight Commander", "THE File manager", R.layout.tut_mc, R.drawable.sym_keyboard_done));
        ...
        items.add(new tutlistitem(zContext, "Compiling C Apps", "Adding more native apps to Terminal IDE", R.layout.tut_expand, R.drawable.sym_keyboard_done));
