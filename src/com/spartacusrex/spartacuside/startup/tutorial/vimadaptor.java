...
public class vimadaptor extends gen_adaptor{
    ...
    public vimadaptor(Context zContext){
        ...
        items.add(new tutlistitem(zContext, "Tutorial 2", "Hello World!", R.layout.tut_first_2, R.drawable.app_terminal));
        items.add(new tutlistitem(zContext, "Tutorial 3", "Java library", R.layout.tut_first_3, R.drawable.sym_keyboard_done));
        items.add(new tutlistitem(zContext, "Tutorial 4", "Full command line app", R.layout.tut_first_4, R.drawable.sym_keyboard_done));
